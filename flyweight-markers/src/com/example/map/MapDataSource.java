...
public class MapDataSource {
    ...
    public List<MapMarker> loadMarkers(int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            // Directly takes intrinsic properties from the factory 
            MarkerStyle style = styleFactory.get(shape, color, size, filled);

            // Creating new MapMarker but now we should make use of the MarkerStyle and pass style as a parameter instead of all intrinsic properties again and again
