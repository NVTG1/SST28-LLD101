...
public class IncidentTicket {
    ...
    // Used final for them to not change after construction
    ...
    // Private constructor so that only Builder can create it 
    ...
    // Builder
    // To get readable object creation so as to not have the user learn its order in which the parameters should be passed 
    public static class Builder {
        ...
        // All validations in one place not scattered in TicketService 
        // Handles creation too
